...
/* harmony import */ var _modules_init_carousels__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-carousels */ "./js/modules/init-carousels.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_tabs__WEBPACK_IMPORTED_MODULE_2__["initTabs"])();
  Object(_modules_init_video__WEBPACK_IMPORTED_MODULE_1__["initVideo"])();
  Object(_modules_init_carousels__WEBPACK_IMPORTED_MODULE_3__["initCarousels"])();
  document.documentElement.style.setProperty('--scrollbarWidth', "".concat(window.innerWidth - document.body.clientWidth, "px"));
});

/***/ }),

/***/ "./js/modules/init-carousels.js":
/*!**************************************!*\
  !*** ./js/modules/init-carousels.js ***!
  \**************************************/
/*! exports provided: initCarousels */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initCarousels = function initCarousels() {
  var responses = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.responses__swiper', {
    direction: 'horizontal',
    spaceBetween: 405,
    grabCursor: true,
  ...
  var instructors = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.instructors__swiper', {
    direction: 'horizontal',
    updateOnWindowResize: true,
    spaceBetween: 300,
    grabCursor: true,
  ...
  var deleteTabindex = function deleteTabindex() {
    var slideDuplicate = document.querySelectorAll('.swiper-slide-duplicate');
    slideDuplicate.forEach(function (el) {
...
var tabLinks = document.querySelectorAll('.subscription__item-time');
var initTabs = function initTabs() {
  ...
  function openTabs(el) {
    if (el.code === 'Enter' || el.code === 'Space' || el.button === 0) {
      var tabLink = document.querySelectorAll('.subscription__item-time');
      var tabContent = document.querySelectorAll('.subscription__price, .subscription__subtitle');
      var btnTarget = el.currentTarget;
      var time = btnTarget.dataset.time;
      el.preventDefault();
      tabContent.forEach(function (elem) {
        elem.classList.remove('active');
      });
      tabLink.forEach(function (elem) {
        elem.classList.remove('active');
      });
      var tabContentActive = document.querySelectorAll("[data-price=\"".concat(time, "\"]"));
      tabContentActive.forEach(function (elem) {
...
var button = document.querySelector('.promo__video-button');
